...
db.run(`INSERT INTO partidos (fecha, equipo_local,equipo_visitante,goles_local_descanso,goles_local_final,goles_visitante_descanso,goles_visitante_final,porcentaje_empate,porcentaje_victoria_local,porcentaje_victoria_visitante) VALUES (?,?,?,?,?,?,?, ?,?, ?)`, [fecha, equipo_local,equipo_visitante,goles_local_descanso,goles_local_final,goles_visitante_descanso,goles_visitante_final,porcentaje_empate,porcentaje_victoria_local,porcentaje_victoria_visitante], function(err) {
  if (err) {
